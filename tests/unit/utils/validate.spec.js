...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/fyr/vue-element-admin')).toBe(true)
    expect(validURL('http://github.com/fyr/vue-element-admin')).toBe(true)
    expect(validURL('github.com/fyr/vue-element-admin')).toBe(false)
  })
  it('validLowerCase', () => {
